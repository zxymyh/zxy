...
let dsSelect_models={
    ...
    "baseModel":function(){
        let str = '<div class="left">' +
            ...
            '</div>' +
            '<div class="center">' +
            '<div class="dsButton selectRight"> 确认选择 </div>' +
            '<div class="dsButton selectLeft"> 删除选择 </div>' +
            /*'<div class="dsButton allRight"> >>> </div>' +*/
            '<div class="dsButton allLeft"> 全部删除 </div>' +
            '<div class="dsButton1" onclick="disableButtons()"> 锁定选择 </div>'+
            '<div class="dsButton1" onclick="start()"> 开启选择 </div>'+
            '</div>' +
            '<div class="right">'+
            '<ul class="dsList">' +
            '</ul>' +
